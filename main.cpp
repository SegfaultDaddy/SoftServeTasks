...
int main()
{
    ...
    */
    string_list::push_back(list, "L");
    string_list::push_back(list, "H");
    string_list::push_back(list, "H");
    string_list::push_back(list, "H");
    string_list::push_back(list, "H");
    string_list::push_back(list, "Y");
    string_list::push_back(list, "H");
    string_list::push_back(list, "H");
    string_list::push_back(list, "H");
    string_list::push_back(list, "H");
    string_list::push_back(list, "P");
    string_list::push_back(list, "P");
    string_list::push_back(list, "P");
    string_list::push_back(list, "P");
    string_list::push_back(list, "P");
    ...
    string_list::push_back(list, "Z");
    string_list::push_back(list, "Z");
    string_list::push_back(list, "D");
    string_list::push_back(list, "X");
    string_list::push_back(list, "Q");
    string_list::push_back(list, "Q");
    string_list::push_back(list, "Q");
    string_list::push_back(list, "Q");
    string_list::push_back(list, "Q");
    string_list::push_back(list, "R");
    string_list::push_back(list, "T");
    string_list::push_back(list, "L");

    std::println("Size: {}", string_list::size(list));
    string_list::sort(list);
    std::println("Head: {}", string_list::implementation::value(string_list::implementation::head(list)));
    auto tail{string_list::implementation::tail(list)};
    std::println("Tail: {}, next {}", string_list::implementation::value(tail), (void*)string_list::implementation::next(tail));
